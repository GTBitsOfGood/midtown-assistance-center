                    ...
                    <div className="ro">
                        ...
                        <div className="col-xs-8 col-xs-offset-2">
                            ...
                            <div className="col-md-offset-2 col-md-8 mx-auto text-center">
                                <p>We connect students with college students for tutoring!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="">
                        <div className="row">
                            ...
                            <div className="col-md-offset-2 col-md-8 mx-auto text-center">
                                <p>
                                    Midtown Assistance Center (MAC) is a non-profit, interfaith organization whose
                                    mission is to provide emergency assistance to low-income working Atlantans to help
                                    prevent homelessness and hunger during periods of crisis.
                                </p>
                            </div>
                        </div>
                    </div>
