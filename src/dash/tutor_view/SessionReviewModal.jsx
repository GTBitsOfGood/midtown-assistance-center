...
class SessionModal extends React.Component {
  ...
  render() {
    ...
    for (let student in this.props.session.students_attended) {
      renStudents.push(
        <h5>{this.props.session.students_attended[student].student_id}</h5>
      );
    }
        ...
        renRequests.push(
          <div className="student-join-request col-sm-12">
            ...
            <h5 className="lighter-text col-sm-4">
              {this.props.session.join_requests[student].student_comment
                ? this.props.session.join_requests[student].student_comment
                : 'No Request Description'}
            </h5>
            <span
              onClick={() =>
                this.approveStudent(this.props.session.join_requests[student])
              }
              className="col-sm-1 glyphicon glyphicon-ok approve-student"
            />
            <span
              onClick={() =>
                this.denyStudent(this.props.session.join_requests[student])
              }
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content tutor-modal review-modal">
              <div className="modal-header text-center">
                ...
                <h5>
                  <a href={this.props.session.hangouts_link} target="_blank">
                ...
                <div id={'ModalBody_' + this.props.id}>
                  <div className="modal-body-session-info">
                    ...
                    {renRequests.length === 0 ? (
                      <h5 className="lighter-text">No Open Join Requests</h5>
                    ) : (
                      renRequests
                    )}
                  </div>
                  <div className="modal-body-session-info">
                    ...
                    {renStudents.length === 0 ? (
                      <h5 className="lighter-text">No Students in Session</h5>
                    ) : (
                      renStudents
                    )}
                  </div>
                  <div className="modal-body-session-rating">
                    <h4>
                      <small>How was your tutoring session?</small>
                    </h4>
                    <h5
                      className={
                    ...
                    <h5>
                      Leave some comments about any issues or misbehaving
                      students (optional)
                    </h5>
                    <textarea
