            ...
            <div className="col-xs-12 col-sm-offset-1 col-sm-10">
              <div className="row">
                <div className="col-sm-6 col-md-5 profile-pic-wrapper">
                  ...
                  <div
                    className={'edit-img-input-' + this.state.editProfilePic}
                  >
                    <input
                ...
                <div className="col-sm-12">
                  <div className="form-group">
                    <div className="row tutor-profile-input">
                      <div className="col-xs-12">
                        ...
                        <p>
                          {new Date(this.props.user.join_date).toDateString()}
                        </p>
                      </div>
                    </div>
                    <div className="row tutor-profile-input">
                    ...
                    <div className="row tutor-profile-input">
                      <div className="col-xs-12">
                        <h5>
                          <i className="glyphicon glyphicon-envelope" /> Gmail:
                        </h5>
                        <textarea
                          type="text"
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-xs-12">
                      <h5>
                        <i className="glyphicon glyphicon-apple" /> Subjects:
                      </h5>
                      {subjectItems}
                      <button
                  ...
                  <div className="row">
                    <div className="col-xs-12">
                      <h5>
                        <i className="glyphicon glyphicon-apple" /> Favorites:
                      </h5>
                      {favoriteItems}
                      <button
                        className="btn btn-success add-subject"
                  ...
                  <div className="row">
                    <div className="col-xs-12">
                      <h5>
                        <i className="glyphicon glyphicon-time" /> Schedule:
                      </h5>
                      {availabilityItems}
                      <button
