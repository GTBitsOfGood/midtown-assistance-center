...
class TutorList extends React.Component {
  render() {
    const renData =
      this.props.studentView.filteredTutors.length > 0 ? (
      ...
      <div>
        <h4 className="tutors-header">
          ...
          <span className="gold_text">
            {"'" +
              (this.props.studentView.searchSubject
                ? this.props.studentView.searchSubject + ' '
                : '') +
              this.props.studentView.searchTime +
              "'"}
          </span>
        </h4>
        <span>
    ...
    return (
      <div className="col-md-10 col-md-offset-1 tutor-list-wrapper">
        <div className="search-list-header">
          {this.props.studentView.searchType === 'online'
            ? tutorsOnline
            : searchResults}
        </div>
        <div
