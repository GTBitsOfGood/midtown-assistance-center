...
class TutorModal extends React.Component {
    ...
    render() {
        ...
        const pending_html = <div>
            ...
            <h6>{this.state.approval === 'new' ? '' : 'Your request is awaiting approval from the tutor'}</h6>
        </div>;
                        ...
                        <div className="modal-content review-modal">
                            ...
                            <div className="modal-body text-center">
                                <div id={'ModalBody_' + this.props.firstName}>
                                    {this.state.approval === 'in_session' ? in_session_html :
                                        (this.state.approval === 'pending' || this.state.approval === 'new') ? pending_html :
                                            this.state.approval === 'approved' ? approved_html :
                                                this.state.approval === 'rejected' ? rejected_html : ''
                                    }
                                </div>
                            </div>
