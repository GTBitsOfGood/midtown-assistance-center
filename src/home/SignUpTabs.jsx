    ...
    return (
        <div className="">
            ...
            <div className="animated fadeInLeft">
                <div className="signup-form-bkgrd col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-4"></div>
                <div className="animated fadeInLeft col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-4 text-center signup-form container">
                    ...
                    <Tabs className="signup-tabs" defaultActiveKey={1} id="uncontrolled-tab-example">
